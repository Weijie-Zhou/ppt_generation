...
if __name__ == "__main__":
    # Load LLM
    tokenizer = AutoTokenizer.from_pretrained('/root/autodl-tmp/ZhipuAI/chatglm3-6b-lora', trust_remote_code=True)
    model = AutoModel.from_pretrained('/root/autodl-tmp/ZhipuAI/chatglm3-6b-lora', trust_remote_code=True, device_map="auto").eval()
